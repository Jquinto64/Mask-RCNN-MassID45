...
# LazyConfig Training Script - pretrained new baseline (NO SR)
TILE_SIZE=512
...
# # LazyConfig Training Script - pretrained new baseline (SR)
...
# train.output_dir=output_2x_zoom_SR_${SR_METHOD}_v9 \
# dataloader.train.dataset.names=lifeplan_${SR_METHOD}_train \
# dataloader.test.dataset.names=lifeplan_${SR_METHOD}_valid \
