...
########################## VARIABLE TILE SIZE - 15K ITERS (NO SR) ######################################################
TILE_SIZE=512
...
# python sahi_inference.py --model_path /h/jquinto/Mask-RCNN/output_${TILE_SIZE}_sahi_tiled_v9/model_0004884.pth \
...
# python sahi_inference.py --model_path /h/jquinto/Mask-RCNN/output_${TILE_SIZE}_sahi_tiled_v9/model_0009769.pth \
...
# ########################### VARIABLE TILE SIZE - 15K ITERS (SR) ######################################################
# # BASE TILE SIZE (prior to SR)
# TILE_SIZE=512
# SR_METHOD=swinir_bioscan

# # FOR RUNNING ON NO SUPER RESOLUTION, DOTA AUGS MODEL
# # (while true; do nvidia-smi; top -b -n 1 | head -20; sleep 10; done) & 
# python sahi_inference.py --model_path /h/jquinto/Mask-RCNN/output_2x_zoom_SR_${SR_METHOD}_v9/model_0004884.pth \
# --exp_name lifeplan_b_2x_zoom_SR_${SR_METHOD}_v9_R50_one_cycle_5e-5_epoch_1_15k_iters_orig_scale \
# --dataset_json_path /h/jquinto/lifeplan_b_v9_cropped_center/annotations/instances_val2017.json \
...
# # FOR RUNNING ON NO SUPER RESOLUTION, DOTA AUGS MODEL
# # (while true; do nvidia-smi; top -b -n 1 | head -20; sleep 10; done) & 
# python sahi_inference.py --model_path /h/jquinto/Mask-RCNN/output_2x_zoom_SR_${SR_METHOD}_v9/model_0009769.pth \
# --exp_name lifeplan_b_2x_zoom_SR_${SR_METHOD}_v9_R50_one_cycle_5e-5_epoch_2_15k_iters_orig_scale \
# --dataset_json_path /h/jquinto/lifeplan_b_v9_cropped_center/annotations/instances_val2017.json \
# --dataset_img_path /scratch/ssd004/scratch/jquinto/lifeplan_b_v9_cropped_center_sr_${SR_METHOD}/val2017 \
# --config_path /h/jquinto/Mask-RCNN/configs/new_baselines/mask_rcnn_R_50_FPN_100ep_LSJ.py \
# --crop_fac 16 \
...
# # FOR RUNNING ON NO SUPER RESOLUTION, DOTA AUGS MODEL
# # (while true; do nvidia-smi; top -b -n 1 | head -20; sleep 10; done) & 
# python sahi_inference.py --model_path /h/jquinto/Mask-RCNN/output_2x_zoom_SR_${SR_METHOD}_v9/model_final.pth \
# --exp_name lifeplan_b_2x_zoom_SR_${SR_METHOD}_v9_R50_one_cycle_5e-5_epoch_3_15k_iters_orig_scale \
# --dataset_json_path /h/jquinto/lifeplan_b_v9_cropped_center/annotations/instances_val2017.json \
# --dataset_img_path /scratch/ssd004/scratch/jquinto/lifeplan_b_v9_cropped_center_sr_${SR_METHOD}/val2017 \
# --config_path /h/jquinto/Mask-RCNN/configs/new_baselines/mask_rcnn_R_50_FPN_100ep_LSJ.py \
# --crop_fac 16 \
...
# # (while true; do nvidia-smi; top -b -n 1 | head -20; sleep 10; done) & 
# python sahi_inference.py --model_path /h/jquinto/Mask-RCNN/output_2x_zoom_SR_${SR_METHOD}_v9/model_final.pth \
# --exp_name lifeplan_b_2x_zoom_SR_${SR_METHOD}_v9_R50_one_cycle_5e-5_epoch_3_15k_iters_TEST_SET_orig_scale \
# --dataset_json_path /h/jquinto/lifeplan_b_v9_cropped_center/annotations/instances_test2017.json \
